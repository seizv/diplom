...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 19 2016 г., 22:05
...
-- База данных: `seiz`
--
CREATE DATABASE IF NOT EXISTS `seiz` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `seiz`;
...
--
ALTER TABLE `category`
  MODIFY `id_category` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
